...
class BaseDocumentParser(ABC):
    ...
    # Subclasses set this agentic_rag_service can store the parser name.
    ...
    def _caption_tables(self, tables: list[ExtractedTable]) -> None:
        ...
        for tbl in tables:
            ...
            try:
                ...
                if len(table_md) > settings.HEALERRAG_MAX_TABLE_MARKDOWN_CHARS:
                    table_md = table_md[:settings.HEALERRAG_MAX_TABLE_MARKDOWN_CHARS] + "\n... (truncated)"
