"""
HealerRAG Data Models
===================

Dataclasses for the HealerRAG pipeline: document parsing, enriched chunks,
...
class ExtractedTable:
    ...
    caption: str = ""          # LLM-generated description based on table content
    num_rows: int = 0
    num_cols: int = 0
...
class EnrichedChunk:
    ...
    document_id: int
    page_no: int = 0
    heading_path: list[str] = field(default_factory=list)  # e.g. ["Introduction", "Background"]
