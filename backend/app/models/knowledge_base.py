...
"""
# default    → giá trị khi INSERT (tạo mới)
# onupdate   → giá trị khi UPDATE (cập nhật)
...
class KnowledgeBase(Base):
    ...
    kg_entity_types: Mapped[list[str] | None] = mapped_column(JSON, nullable=True, default=None)
