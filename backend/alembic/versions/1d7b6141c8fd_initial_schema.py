...
Revision ID: 1d7b6141c8fd
Revises: 
Create Date: 2026-04-13 18:41:37.118393
...
def upgrade() -> None:
    ...
    sa.Column('kg_language', sa.String(length=50), nullable=True),
    sa.Column('kg_entity_types', sa.JSON(), nullable=True),
